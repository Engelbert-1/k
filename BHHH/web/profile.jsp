...
<html lang="en">
    ...
    <a href="home"><img src="https://logosandtypes.com/wp-content/uploads/2022/07/Kansai-Paint.png" alt="Kansai Paint Logo" width="40"></a>
</div>
                </div>
                        ...
                        <div class="card-body text-center box_info">
                            ...
                            <form id="fima">
                                <label for="form_file" class="edit" value="aa">
                                    <div style="color: #0D6EFD;font-size: 16px">JPG or PNG không quá 5 MB
                        ...
                        <div class="container d-flex justify-content-center">
                            <div class="card p-3" style="margin: 10px 0">
                                <div class="d-flex flex-row justify-content-center text-align-center">
                                    ...
                                    <p class="text-dark">Ví mua hàng</p>
                                </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form method="post" action="profile">
                                <div class="mb-3">  
                                    <label class="mb-1" for="inputUsername">Tên người dùng</label>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <label class="mb-1" for="inputOrgName">Vị trí</label>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <label class="mb-1" for="inputPhone">SĐT</label>
                                ...
                                <button style="" class="btn btn-primary" onclick="acceptRead()" id="buttonVip" type="button">Sửa hồ sơ</button>

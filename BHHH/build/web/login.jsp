    ...
    <section class="fxt-template-animation fxt-template-layout1">
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="fxt-content" >
                        <div class="fxt-header" style="margin-bottom: 15px">
                            <a href="home" class="fxt-logo">
                                <img src="https://logosandtypes.com/wp-content/uploads/2022/07/Kansai-Paint.png" alt="Kansai Paint Logo" width="50" height="auto">
                            </a>
                            <div class="fxt-page-switcher">
                                <a href="login" class="switcher-text1 active" style="color: #003366;">Log In</a>
                                <a href="register" class="switcher-text1">Register</a>
                            </div>
                        </div>
                        <div class="fxt-form">
                            <h2 style="color: #003366">Log In</h2>
                                ...
                                <div class="form-group">
                                    <div class="fxt-transformY-50 fxt-transition-delay-3">
                                        <div class="fxt-content-between">
                                            <button type="submit" class="fxt-btn-fill" style="background-color: #003366; color: white;">Log in</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                ...
                <div class="col-md-6 col-12 fxt-none-767 fxt-bg-img" data-bg-image="https://sondaiphugia.com/wp-content/uploads/2018/10/cach-tinh-luong-son-tuong-nha-chuan-xac-nhat.gif"></div>
            </div>
        </div>
    </section>

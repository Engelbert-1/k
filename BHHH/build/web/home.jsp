...
<html lang="en">
    ...
    <head>
        ...
        <title>Clock</title>
        <link rel="icon" href="http://duhocducnhantam.edu.vn/wp-content/uploads/2021/09/bieu-tuong-cua-Duc-1.png" />
    ...
    <body>
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-lg-2">
                                <div class="logo">
                                    <a href="home">
                                        <img src="http://duhocducnhantam.edu.vn/wp-content/uploads/2021/09/bieu-tuong-cua-Duc-1.png" alt="Clock Logo" width="40" height="auto">
                                    </a>
                                </div>
                            </div>
        ...
        <section class="slider_section slider_section mb-66" style="margin-bottom: 0px">
            <div class="slider_area owl-carousel">
                <div class="single_slider d-flex align-items-center" style="background: url('images/slider/1.png'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
                ...
                <div class="single_slider d-flex align-items-center" style="background: url('images/slider/4.png'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
                        ...
                        <div class="home_section_left">
                            ...
                            <div class="deals_product_area mb-68">
                                <div class="section_title section_title_style2">
                                    <h2><span class="">Hot Deals</span></h2>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-7">
                            <div class="widgets_container contact_us">
                                ...
                                <div class="footer_desc">
                                    <p>Được thành lập vào năm 2020, trải qua 4 năm hoạt động và phát triển, chuỗi cửa hàng đồng hồ WatchStore trở thành đại lý ủy quyền cho rất nhiều thương hiệu đến từ Nhật Bản và Thụy Sỹ chuyên bán đồng hồ đeo tay chính hãng.</p>
                                </div>
                                <p>
                                    <span>Địa chỉ :</span> Vân Cốc 1, Vân Trung, Việt Yên, Bắc Giang
                                </p>
                                <p><span>Email :</span> <a href="#">DucNVHE186352@fpt.edu.vn</a></p>
                                <p><span>Phone :</span> <a href="tel: +91 8888884444">0916744301 - 0977475759</a> </p>
                            ...
                            <div class="widgets_container widget_menu">
                                ...
                                <div class="footer_menu">
                                    <ul>
                                        ...
                                        <li><a href="refine?cid_refine=5">Sơn dự án</a></li>
                                        <li><a href="profile">Tài khoản của tôi</a></li>
                                        <li><a href="viewcart">Đơn hàng</a></li>
                                        <li><a href="viewwishlist">Danh sách yêu thích</a></li>
                                        <li><a href="contact">Liên hệ</a></li>
                                    </ul>
                                </div>
                            </div>

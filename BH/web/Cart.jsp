...
<html>
    <head>
        ...
        <style>
    body {
        background-image: url('https://sonnano40.vn/upload/images/chon-mau-son-cho-nha.jpg');
                ...
                <div class="px-4 px-lg-0">
                    ...
                    <div class="pb-5">
                        ...
                        <div class="row py-5 p-4 bg-white rounded shadow-sm">
                            <div class="col-lg-6" style="background-image: url('https://nipponpaint.com.vn/sites/default/files/inline-images/son-tuong-nha-cu-6.jpg'); background-size: cover; background-position: center; height: 400px; border-radius: 15px;">
</div>
                            <div class="col-lg-6">

...
<html>
    <head>
        ...
        <style>
            body {
                background-image: url('https://sondaiphugia.com/wp-content/uploads/2018/10/cach-tinh-luong-son-tuong-nha-chuan-xac-nhat.gif'); /* Set background image */
                                ...
                                <div class="row">
                                    ...
                                    <aside class="col-sm-7">
                                        <article class="card-body p-5">
                                            ...
                                            <hr>
                                            <a href="Buy.jsp" class="btn btn-lg btn-primary text-uppercase"> Buy now </a>

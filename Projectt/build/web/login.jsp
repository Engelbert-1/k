                ...
                <div class="wrap">
                    <div class="login-wrap p-4 p-md-5">
                        ...
                        <form action="login" method="post" class="signin-form">
                            <p class="text-danger">${requestScope.error != null ? requestScope.error : ""}</p>
                            <div class="form-group mt-3">
                                <input name="user" type="text" class="form-control" required value="${cookie.user != null ? cookie.user.value : ""}">
                            ...
                            <div class="form-group d-md-flex">
                                <div class="w-50 text-left">
                                    <label class="checkbox-wrap checkbox-primary mb-0">Remember Me
                                        <input name="remember" ${cookie.remember != null && cookie.remember.value == 'on' ? "checked" : ""} type="checkbox" value="on">
                    ...
                    <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                        <img src="image/68478341_p0_master1200.jpg" class="img-fluid rounded" alt="Login Image">
                    </div>
                </div>
            </div>
        </div>

                                    ...
                                    <div style="padding: 10px 15px">
                                        <div class="d-flex justify-content-between p-md-1">
                                            ...
                                            <div style="text-align: end">
                                                <h4 style="color: #1B813A">Tổng sản phẩm</h4>
                                                <p class="mb-0"></p>
                            ...
                            <div class="card">
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div style="text-align: end"> 
                                            <h4 style="color: #06439F;">Số sản phẩm đã bán</h4>
                                            <p class="mb-0"></p>
                            ...
                            <div class="card">
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div style="text-align: end">
                                            <h4 style="color: #E94644;">Tổng khuyến mại</h4>
                                            <p class="mb-0"></p>
                            ...
                            <div class="card">
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div style="text-align: end">
                                            <h4 style="color: #06439F;">Tổng người dùng</h4>
                                            <p class="mb-0"></p>
                            ...
                            <div class="card">
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div style="text-align: end">
                                            <h4 style="color: black;">Tổng loại sản phẩm</h4>
                                            <p class="mb-0"></p>
                            ...
                            <div class="card">
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div style="text-align: end">
                                            <h4 style="color: #1B813A;">Tổng nhà sản xuất</h4>
                                            <p class="mb-0"></p>

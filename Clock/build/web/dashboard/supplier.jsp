                                ...
                                <table class="table table-hover text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text_page_head" scope="col">Tên công ty</th>
                                            <th class="text_page_head" scope="col">SĐT</th>
                                            <th class="text_page_head" scope="col">Tên liên hệ</th> 
                                            <th class="text_page_head" scope="col">Quốc gia</th> 

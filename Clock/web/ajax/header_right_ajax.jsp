                    ...
                    <li id="productsCart" class="mini_cart_wrapper">
                        ...
                        <div class="mini_cart mini_cart2">
                            <div class="cart_gallery" style="max-height: 250px; overflow-y: auto;">
                                        ...
                                        <c:forEach items="${sessionScope.listItemsInCart}" var="p">
                                            <div class="cart_item">
                                                ...
                                                <div class="cart_info">
                                                    ...
                                                    <p><span>$ ${p.price}</span> X ${p.quantity}</p>
                                                </div>
                                ...
                                <c:if test="${sessionScope.cart == null || sessionScope.cartSize == 0}">
                                    <span class="header__cart-list--no-cart-msg">Chưa có gì!</span>
                            ...
                            <div class="mini_cart_table">
                                <div class="cart_table_border">
                                    ...
                                    <div class="cart_total mt-10">
                                        <span>Tổng :</span>
                                        <span class="price">$. ${sessionScope.cart.getTotalMoney()}</span>
                                    </div>
                            ...
                            <div class="mini_cart_footer">
                                <div class="cart_button">
                                    <a href="${sessionScope.account == null ? 'login' : 'viewcart'}">Xem giỏ hàng</a>
                                </div>
                            </div>
                        </div>
                    </li>
                ...
                <ul>
                    <li class="top_links">
                        ...
                        <ul class="dropdown_links">
                            ...
                            <li><a href="profile">Giỏ hàng</a></li>
                        </ul>
                    </li>
                    <c:if test="${sessionScope.account!=null}">

                                ...
                                <table class="table table-hover text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th  class="text_page_head" scope="col">Mã đơn hàng</th>
                                            <th class="text_page_head" scope="col">Tên người dùng</th>
                                            <th class="text_page_head" scope="col">Tổng tiền($)</th>
                                            <th class="text_page_head" scope="col">Ngày đặt hàng</th>
                                            <th class="text_page_head" scope="col">Tình trạng</th>
                                        </tr>
                                    </thead>
                                    <tbody id="content">

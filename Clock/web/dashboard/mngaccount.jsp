                        ...
                        <div class="card-body" style="padding: 0">
                            <div class="table-responsive">
                                <table class="table table-hover text-nowrap">
                                    <thead>
                                        <tr>
                                            <th class="text_page_head">Tên đầy đủ</th>
                                            <th class="text_page_head">Avatar</th>
                                            <th class="text_page_head">Tên người dùng</th>
                                            <th class="text_page_head">Địa chỉ</th>
                                            <th class="text_page_head">Vị trí</th>
                                            <th class="text_page_head">SĐT</th>
                                            <th>

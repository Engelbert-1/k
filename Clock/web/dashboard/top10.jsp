                    ...
                    <section class="mb-4">
                        <div class="card"> 
                            <div class="card-header py-3">
                                <h3 style="padding: 10px" class="mb-0 text-center"><strong>TOP 10 Sản phẩm</strong></h3>
                            </div>
                                ...
                                <table class="table table-hover text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text_page_head" scope="col">Tên</th>
                                            <th class="text_page_head"  style="text-align: center" scope="col">ảnh</th>
                                            <th class="text_page_head" scope="col">Giá</th>
                                            <th class="text_page_head" scope="col">Số lượng đã bán</th>
                                        </tr>
                                    </thead>
                                    <tbody>

                        ...
                        <li id="productsCart" class="mini_cart_wrapper">
                            ...
                            <div class="mini_cart mini_cart2">
                                <div class="cart_gallery" style="max-height: 250px; overflow-y: auto;">
                                            ...
                                            <c:forEach items="${sessionScope.listItemsInCart}" var="p">
                                                <div class="cart_item">
                                                    ...
                                                    <div class="cart_info">
                                                        ...
                                                        <p style="color: black"><span style="color: black">$ ${p.price}</span> X ${p.quantity}</p>
                                                    </div>
                                    ...
                                    <c:if test="${sessionScope.cart == null || sessionScope.cartSize == 0}">
                                        <span style="color: black" class="header__cart-list--no-cart-msg">Chưa có gì</span>
                                ...
                                <div class="mini_cart_table">
                                    <div class="cart_table_border">
                                        <div class="cart_total">
                                            <span style="color: black">Tổng phụ :</span>
